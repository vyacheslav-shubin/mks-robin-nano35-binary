...
Прошивка и сопутствующие дополнения к ней состоит из файлов:
  ...
  cfg/pid_config.gcode - демонстрационный файл конфигурирования PID термостатов. При запуске файла включается специальный виджет, показывающий динамику температуры
  preview-test - тестовые файлы для проверки алгоритмов превью
  0X00000.BIN, 0X10000.BIN - прошивка модуля WiFi
  
  0X00000.BIN, 0X10000.BIN, RESDUMP.BIN не следует переименовывать с использованием маленьких букв. marlin2 не поддерживает удаление и изменение имен файлов с длинными именами,
